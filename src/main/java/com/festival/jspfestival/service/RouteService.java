...
public class RouteService {
    ...
    public Route saveRoute(String tripName, user user, List<String> contentIds) {
        String contentIdsString = String.join(",", contentIds); // List를 ,로 연결
        Route route = new Route(tripName, user, contentIdsString);
    ...
    public List<String> getContentIds(int routeId) {
        ...
        if (route != null) {
            return List.of(route.getContentIds().split(","));
        }
        return null;
    }
